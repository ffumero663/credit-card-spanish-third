...
fetch('/html/footer.html')
  ...
  fetch('/html/header-inside-buttons.html')
  .then(response => response.text())
  .then(data => {
...
fetch('/html/card-issuer-components/mastercard/on-this-page.html')
  .then(response => response.text())
  .then(data => {
  ...
  function textAppear() {
    ...
    if(textDiv.style.display === 'none' || textDiv.style.display === ''){
      ...
      button.innerHTML = 'Summary <img src="/images/CardIssuer/new-icons/minus-icon-banks.png" alt="minus icon">'
    } else{
      textDiv.style.display = "none";
      button.innerHTML = 'Summary <img src="/images/CardIssuer/new-icons/plus-icon-banks.png" alt="plus icon">';
    }
  }
